...
void furnitureInv::Grid2by2(sf::View &view, sf::RenderWindow &window){
...
void furnitureInv::Grid5by2(sf::View &view, sf::RenderWindow &window){
...
void furnitureInv::Grid4by4(sf::View &view, sf::RenderWindow &window){
	std::vector<sf::RectangleShape>  FiveByTwo(16, sf::RectangleShape(gridBox));
	...
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			FiveByTwo[i].setPosition(view.getCenter().x - 128 + (i * 64), view.getCenter().y - 128 + (j * 64));
			window.draw(FiveByTwo[i]);
		}
	}
...
// BIN (2x2)
void furnitureInv::drawBin(sf::View &view, sf::RenderWindow &window) {
	...
	window.draw(bin);
	Grid2by2(view, window);
}
// DESK (2x2) 
void furnitureInv::drawDesk(sf::View &view, sf::RenderWindow &window) {
...
// LOCKER (2x2)
void furnitureInv::drawLocker(sf::View &view, sf::RenderWindow &window) {
...
// BIG BIN (4x4)
void furnitureInv::drawBigBin(sf::View &view, sf::RenderWindow &window) {
	...
	window.draw(BigBin);
	Grid4by4(view, window);
}
//TOOLS CABINET (4x4)
void furnitureInv::drawToolsCabinet(sf::View &view, sf::RenderWindow &window) {
...
// FOOTLOCKER (5x2)
void furnitureInv::drawFootLocker(sf::View &view, sf::RenderWindow &window) {
